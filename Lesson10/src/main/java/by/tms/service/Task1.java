...
public class Task1 {
    public static void main(String[] args) {
        Robot firstRobot = Robot.builder()
                .hand(SamsungHand.builder()
                        .price(20)
                        .build())
                .head(ToshibaHead.builder()
                        .price(60)
                        .build())
                .leg(SamsungLeg.builder()
                        .price(30)
                        .build())
                .build();
        Robot secondRobot = Robot.builder()
                .hand(SonyHand.builder()
                        .price(15)
                        .build())
                .head(SonyHead.builder()
                        .price(20)
                        .build())
                .leg(ToshibaLeg.builder()
                        .price(19)
                        .build())
                .build();
        Robot thirdRobot = Robot.builder()
                .hand(ToshibaHand.builder()
                        .price(18)
                        .build())
                .head(SamsungHead.builder()
                        .price(16)
                        .build())
                .leg(SonyLeg.builder()
                        .price(17)
