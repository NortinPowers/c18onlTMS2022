...
<div class="card mr-5 ml-5 mt-5 shadow bg-body-tertiary rounded" style="max-width: 14rem">
    ...
    <c:if test="${access != null}">
        <div class="btn-group btn-group-sm">
            ...
            <a href="<c:url value="/eshop?command=add-cart&id=${product.id}&shop=none&location=product-page"/>"
               class="btn btn-success">
                <div class="text-center mt-1">
                    <i class="bi bi-cart-plus"></i>
                </div>
            </a>
            <a href="<c:url value="/eshop?command=add-favorite&id=${product.id}&shop=none&location=product-page"/>"
               class="btn btn-success">
                <div class="text-center mt-1">
